...
# 1. Update calculateAtombergCost in InlineEditModal.jsx to support all parameter alias names
...
# 2. Update CostingRunEnginePage.jsx to pass full parameter fields and get MB mappings dynamically
...
echo "==> Costing Engine calculation alignment deployed."
