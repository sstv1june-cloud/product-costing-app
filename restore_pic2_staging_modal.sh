...
echo "==> 2. Updating BaselineMasterPage.jsx with exact Pic 2 staging format (Horizontal Part Carousel + Full 38-Line Vertical Spec Table)..."
...
git add -A
git commit -m "feat(dev-v2): restore exact Pic 2 staging layout (horizontal carousel tabs + vertical 38-line spec table)" || echo "dev-v2 clean."
...
echo "-------------------------------------------------------------------"
echo "✅ SUCCESS! Pic 2 Staging Modal restored on dev-v2."
echo "-------------------------------------------------------------------"
