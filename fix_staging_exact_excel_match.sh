...
echo "==> Updating StagingModal.jsx to display all 38 rows and match Excel total (₹33.22)..."
cat << 'STAGING_EOF' > src/modules/module1-baseline/StagingModal.jsx
...
echo "==> Staging table aligned with Excel sheet!"
