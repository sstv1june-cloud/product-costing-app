...
echo "==> 1. Updating masterStore.js to match exact Edit Spec parameters..."
sed -i 's/runningPostOpCost: 2.15/runningPostOpCost: 1.73/g' src/shared/masterStore.js 2>/dev/null || true

echo "==> 2. Ensuring costCalculationService.js calculates Atomberg with standard post-op cost..."
