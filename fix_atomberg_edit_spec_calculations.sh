...
echo "==> 2. Updating costCalculationService.js with exact Atomberg & Haier formulas..."
...
echo "==> 3. Updating InlineEditModal.jsx with dedicated Atomberg Dual Column & Haier 38-Line Layouts..."
cat << 'MODAL_EOF' > src/modules/module1-baseline/InlineEditModal.jsx
import React, { useState } from 'react';
import { X, Save, Trash2, CheckCircle2, TrendingUp, TrendingDown } from 'lucide-react';
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4 overflow-y-auto">
      <div className="bg-white rounded-2xl max-w-4xl w-full max-h-[92vh] flex flex-col shadow-2xl overflow-hidden text-xs">
        ...
        {/* Dynamic Modal Body: Atomberg Dual Column VS Haier 38-Line */}
        <div className="flex-1 overflow-y-auto p-4 space-y-2">
          {!isHaier ? (
            /* ========================================================================= */
            /* ATOMBERG DUAL COLUMN COSTING TABLE                                       */
            /* ========================================================================= */
            ...
            /* ========================================================================= */
            /* HAIER 38-LINE SPECIFICATION TABLE                                         */
            /* ========================================================================= */
            <table className="w-full text-left border-collapse">
              <thead className="bg-slate-100 text-slate-700 text-[10px] uppercase font-bold sticky top-0 border-b border-slate-200">
                <tr>
              ...
              <tbody className="divide-y divide-slate-100 text-xs font-medium">
                ...
                <tr>
                  ...
                  <td className="py-2 px-3 text-center">Gms</td>
                  <td className="py-2 px-4 text-right">
                    <input type="number" value={formData.runnerWeight} onChange={e => setFormData({ ...formData, runnerWeight: Number(e.target.value) || 0 })} className="w-20 px-2 py-0.5 border border-amber-300 rounded text-right font-bold" />
                  </td>
                  <td className="py-2 px-4 text-right">
                ...
                <tr>
                  ...
                  <td className="py-2 px-3 text-center">Gms</td>
                  <td className="py-2 px-4 text-right">
                    <input type="number" value={formData.netWeight} onChange={e => setFormData({ ...formData, netWeight: Number(e.target.value) || 0 })} className="w-20 px-2 py-0.5 border border-amber-300 rounded text-right font-bold" />
                  </td>
                  <td className="py-2 px-4 text-right">
                ...
                <tr>
                  ...
                  <td className="py-2 px-3 text-center">Gms</td>
                  <td className="py-2 px-4 text-right font-mono font-bold">{Number(haierBaseCalc.shotWeight).toFixed(2)}g</td>
                  <td className="py-2 px-4 text-right font-mono font-bold text-blue-800">{Number(haierRunningCalc.shotWeight).toFixed(2)}g</td>
                ...
                <tr className="bg-slate-50">
                  ...
                  <td className="py-2 px-3 text-center">Gms</td>
                  <td className="py-2 px-4 text-right font-mono font-black text-slate-900">{Number(haierBaseCalc.reconciliationWeight).toFixed(2)}g</td>
                  <td className="py-2 px-4 text-right font-mono font-black text-emerald-600">{Number(haierRunningCalc.reconciliationWeight).toFixed(2)}g</td>
                  <td className="py-2 px-3 text-right font-mono">0.00g</td>
                </tr>
                <tr>
                  ...
                  <td className="py-2 px-3 text-center">Rs</td>
                  <td className="py-2 px-4 text-right font-mono">₹{Number(haierBaseCalc.rawMaterialCost).toFixed(4)}</td>
                  <td className="py-2 px-4 text-right font-mono text-blue-800">₹{Number(haierRunningCalc.rawMaterialCost).toFixed(4)}</td>
                  <td className="py-2 px-3 text-right font-mono">₹0.00</td>
                </tr>
                <tr>
                  ...
                  <td className="py-2 px-3 text-center">Rs</td>
                  <td className="py-2 px-4 text-right font-mono">₹{Number(haierBaseCalc.masterbatchCost).toFixed(4)}</td>
                  <td className="py-2 px-4 text-right font-mono text-blue-800">₹{Number(haierRunningCalc.masterbatchCost).toFixed(4)}</td>
                  <td className="py-2 px-3 text-right font-mono">₹0.00</td>
                </tr>
                <tr className="bg-slate-50 font-bold">
                  ...
                  <td className="py-2 px-3 text-center">Rs</td>
                  <td className="py-2 px-4 text-right font-mono text-slate-900">₹{Number(haierBaseCalc.totalRmCost).toFixed(4)}</td>
                  <td className="py-2 px-4 text-right font-mono text-blue-900">₹{Number(haierRunningCalc.totalRmCost).toFixed(4)}</td>
                  <td className="py-2 px-3 text-right font-mono">₹0.00</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td className="py-2 px-3 text-center">Rs</td>
                  <td className="py-2 px-4 text-right font-mono font-bold">₹{Number(haierBaseCalc.productionCostPerPc).toFixed(4)}</td>
                  <td className="py-2 px-4 text-right font-mono font-bold text-blue-800">₹{Number(haierRunningCalc.productionCostPerPc).toFixed(4)}</td>
                  <td className="py-2 px-3 text-right font-mono">₹0.00</td>
                </tr>
                <tr className="bg-slate-100 font-black">
                  ...
                  <td className="py-2 px-3 text-center">Rs</td>
                  <td className="py-2 px-4 text-right font-mono text-slate-900">₹{Number(haierBaseCalc.subTotal).toFixed(4)}</td>
                  <td className="py-2 px-4 text-right font-mono text-blue-900">₹{Number(haierRunningCalc.subTotal).toFixed(4)}</td>
                  <td className="py-2 px-3 text-right font-mono">₹0.00</td>
                </tr>
                <tr className="bg-purple-50/40">
                  ...
                  <td className="py-2 px-4 text-right font-mono text-blue-800">₹{formData.haierOverheadPackage}</td>
                  <td className="py-2 px-3 text-right font-mono">₹0.00</td>
                </tr>
                <tr className="bg-slate-900 text-white font-black text-xs">
...
echo "==> 4. Updating BaselineMasterPage.jsx with robust Atomberg horizontal + Haier vertical upload parsing..."
...
git add -A
git commit -m "fix(atomberg): restore dedicated Atomberg dual-column costing modal and clean formula engine" || echo "dev-v2 clean."
...
echo "-------------------------------------------------------------------"
echo "✅ SUCCESS! Atomberg Edit Spec calculation and modal restored on dev-v2."
echo "-------------------------------------------------------------------"
