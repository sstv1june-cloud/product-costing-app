...
echo "==> 1. Updating masterStore.js with complete dummy sales dispatch records..."
...
export const globalStore = {
  ...
  // Dummy Sales Dispatches for both Haier and Atomberg
  sales: [
...
echo "==> 2. Updating MisIntelligencePage.jsx with resilient vendor matching..."
...
echo "==> Done! Dummy sales active & MIS fully operational."
