...
echo "==> 1. Staging all current working changes..."
git add -A

echo "==> 2. Committing current snapshot to dev-v2..."
git commit -m "checkpoint: stable baseline, costing engine sync, 6-field costOutputStore & 38-line staging [${TIMESTAMP}]" || echo "Working tree already clean."
...
echo "==> 5. Creating compressed offline backup archive at ${ARCHIVE_NAME}..."
