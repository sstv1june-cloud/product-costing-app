...
echo "==> 2. Setting masterStore.js to a 100% clean 0-data default state..."
...
echo "==> 3. Restoring exact MIS page layout (Image 1 layout) with dynamic calculation..."
...
git add -A
git commit -m "feat(dev-v2): clean slate default store and restore exact 4-section MIS layout" || echo "dev-v2 clean."
...
echo "-------------------------------------------------------------------"
echo "✅ DEV-V2 CLEAN SLATE APPLIED & EXACT MIS LAYOUT RESTORED!"
echo "-------------------------------------------------------------------"
