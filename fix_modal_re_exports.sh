...
echo "==> 1. Updating src/shared/costCalculationService.js with all calculation functions..."
cat << 'CALC_EOF' > src/shared/costCalculationService.js
// ============================================================================
// COST CALCULATION SERVICE (Unified calculations & exports)
// ============================================================================
...
echo "==> 2. Ensuring InlineEditModal.jsx explicitly re-exports all calculation functions..."
...
// Re-export functions expected by consumers
export { 
  calculateAtombergCost, 
  calculateHaierCost, 
  calculateDetailedCost, 
...
echo "==> Exports aligned and dev server restarted!"
