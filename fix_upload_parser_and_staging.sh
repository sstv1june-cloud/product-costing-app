...
echo "==> Updating BaselineMasterPage.jsx with accurate row-matching for BOP, Shift Rate, Packing, and Transport..."
cat << 'PAGE_EOF' > patch_baseline_parser.py
...
PAGE_EOF
python3 patch_baseline_parser.py
...
echo "-------------------------------------------------------------------"
echo "✅ Excel parser updated: Accurate BOP Cost, Shift Rate, and full parameter extraction!"
echo "-------------------------------------------------------------------"
