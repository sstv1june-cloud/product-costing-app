...
echo "==> 1. Adding deleteProductFromBaseline handler in masterStore.js..."
...
echo "==> 2. Updating InlineEditModal.jsx with Delete Product button & confirmation modal..."
...
echo "==> Done! Delete Product button added to Edit Spec modal."
