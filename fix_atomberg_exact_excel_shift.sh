...
echo "==> 1. Updating BaselineMasterPage.jsx parser to handle shifted Atomberg lines..."
cat << 'PAGE_EOF' > patch_atomberg_parser.py
...
PAGE_EOF
python3 patch_atomberg_parser.py
...
echo "-------------------------------------------------------------------"
echo "✅ Layout mapping updated for Atomberg Excel sheets!"
echo "-------------------------------------------------------------------"
